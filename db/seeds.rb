...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    w400.active_event_entrants.create(:athlete_id => curAthlete.id, :points => 1)
    ...
    firstEvents.each do |r|
        ...
        entrants.each do |e|
            if(i == 1)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => kevin.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => nathan.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => leon.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
            elsif(i == 2)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => nathan.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => xi.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
            elsif(i == 3)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => kevin.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => connor.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
            elsif(i == 4)
                AthleteSelection.create!(:meet_id => dohaMeet.id, :user_id => nathan.id, :league_id => hawkeyeXC.id,
                                        :event_id => r.id, :athlete_id => e.id)
